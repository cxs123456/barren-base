...
public class CodeGeneratorDemo {
    ...
    public static void main(String[] args) {
        ...
        // 生成前端文件的包名，输出目录
        String webDir = "api";
        String webPath = projectPath + "/src/test/resources/ui/api/"+moduleName;
        // 配置xml，other文件的输出路径
        ...
        FastAutoGenerator.create(url, username, password)
                ...
                .strategyConfig(builder -> {
                    builder.addInclude(tables) // 设置需要生成的表名
                            ...
                            .entityBuilder().enableLombok().enableActiveRecord().enableTableFieldAnnotation().enableChainModel();
                })
                ...
                .injectionConfig(builder -> {
                    builder.
                            ...
                            .customFile(Collections.singletonMap("api.js", "template/generator/api.js.ftl")); // 自定义配置模板文件
                })
                .execute();
